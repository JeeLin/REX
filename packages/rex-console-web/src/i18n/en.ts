export default {
  ...
  sidebar: {
    ...
    expand: 'Expand',
    favorites: 'Favorites',
    favoritesEmpty: 'Favorite resources for quick access',
    recent: 'Recent',
    recentEmpty: 'Connected resources will appear here',
  ...
  notebooks: {
    ...
    empty: 'No notebooks yet. Click the button above to create one.',
    createDialog: {
      title: 'New Notebook',
      confirm: 'Create',
      titleLabel: 'Title',
      titlePlaceholder: 'Enter notebook title',
    ...
    editor: {
      ...
      command: {
        ...
        selectResourceHint: 'Choose a resource to execute commands on',
  ...
  dashboard: {
    ...
    quickConnectEmpty: 'Connected resources will appear here',
  ...
  settings: {
    ...
    appearance: {
      ...
      languageEn: 'English',
      sidebar: 'Sidebar',
      sidebarDesc: 'Fixed display or collapsible',
      sidebarFixed: 'Fixed',
    ...
    update: {
      ...
      agentRolledBack: 'Rolled Back',
      agentVersionMismatch: 'Version Mismatch',
      autoUpdateOn: 'Auto',
      autoUpdateOff: 'Manual',
  ...
  redis: {
    ...
    keys: {
      ...
      search: 'Search',
      filter: {
        patternPlaceholder: 'Search pattern (e.g. user:*)',
        type: 'Type',
        allTypes: 'All types',
        typeString: 'String',
        typeHash: 'Hash',
      ...
      loading: 'Loading...',
      createKey: '+ New Key',
      createKeyTitle: 'Create Redis Key',
      keyName: 'Key name',
      keyNamePlaceholder: 'e.g. user:1001',
      type: 'Type',
      value: 'Value',
      stringValuePlaceholder: 'Enter value...',
      field: 'Field',
      fieldValue: 'Value',
      addField: 'Add field',
      element: 'Element',
      ...
      batch: {
        ...
        deleteConfirm: 'Are you sure you want to delete the selected {count} keys? This cannot be undone.',
        andMore: '...and {count} more keys',
        deleteBtn: 'Delete {count} keys',
        setTtlTitle: 'Batch Set TTL',
        setTtlConfirm: 'Set the same TTL value for the selected {count} keys.',
        ttlValue: 'TTL Value',
        ttlPlaceholder: 'seconds',
        ttlHint: 'TTL of -1 means no expiration, -2 means key has expired',
        applyTtl: 'Apply',
        minute: 'min',
        hour: 'hr',
        day: 'day',
        ...
        exportConfirm: 'Export information for the selected {count} keys.',
    ...
    import: {
      ...
      detected: 'Detected {format} format with {count} entries',
      key: 'Key',
      type: 'Type',
      valuePreview: 'Value Preview',
      andMore: '...and {count} more entries',
      preview: 'Preview',
      startImport: 'Import {count} keys',
      progress: 'Importing {current}/{total}',
      successCount: '{count} imported successfully',
    ...
    monitor: {
      ...
      notConnected: 'Connect to a Redis server first',
      parseError: 'Failed to parse INFO response',
      fetchError: 'Failed to fetch monitoring data',
      memory: {
        icon: 'M',
        title: 'Memory Usage',
        unlimited: 'Unlimited',
        usedPeak: 'Peak memory',
        rss: 'RSS memory',
      ...
      keys: {
        ...
        total: 'Total keys',
        noKeyspace: 'No keyspace data',
        expiryCount: 'Keys with expiry',
      },
      connections: {
        icon: 'C',
        title: 'Connections',
        ...
        tracking: 'Tracking clients',
        maxClients: 'Max clients',
        rejected: 'Rejected connections',
      },
      commands: {
        icon: 'Q',
        title: 'Command Stats',
        ...
        instantaneousOps: 'Instantaneous OPS',
        hitRate: 'Hit rate',
