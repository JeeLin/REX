export default {
  ...
  redis: {
    ...
    import: {
      title: '批量导入',
      dropHere: '拖放 .json 文件到此处',
      clickToSelect: '或点击选择文件',
      detected: '检测到 {format} 格式，共 {count} 条记录',
      key: '键',
      type: '类型',
      valuePreview: '值预览',
      andMore: '...及另外 {count} 条记录',
      preview: '预览',
      startImport: '导入 {count} 个键',
      progress: '导入中 {current}/{total}',
      successCount: '{count} 个导入成功',
      errorCount: '{count} 个导入失败',
