<template>
  <SettingsSection>
    ...
    <div class="settings-row">
      ...
      <select class="form-select" :value="settingsStore.terminalSettings.fontSize" @change="setFontSize">
    ...
    <div class="settings-row">
      ...
      <select class="form-select" :value="settingsStore.terminalSettings.fontFamily" @change="setFontFamily">
    ...
    <div class="settings-row">
      ...
      <div class="settings-toggle" :class="{ active: settingsStore.terminalSettings.cursorBlink }" @click="toggleCursorBlink"></div>
    </div>
    <!-- Keepalive -->
    <div class="settings-row">
      <div class="settings-row-info">
      ...
      <select class="form-select" :value="settingsStore.terminalSettings.keepalive" @change="setKeepalive">
...
function setFontSize(e: Event) {
  settingsStore.updateTerminalSetting('fontSize', Number((e.target as HTMLSelectElement).value))
}

function setFontFamily(e: Event) {
  settingsStore.updateTerminalSetting('fontFamily', (e.target as HTMLSelectElement).value)
}

function toggleCursorBlink() {
  settingsStore.updateTerminalSetting('cursorBlink', !settingsStore.terminalSettings.cursorBlink)
}

function setKeepalive(e: Event) {
  settingsStore.updateTerminalSetting('keepalive', Number((e.target as HTMLSelectElement).value))
}
</script>
