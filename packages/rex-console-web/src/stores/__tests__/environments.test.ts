...
describe('environments store', () => {
  ...
  describe('fetchEnvironments', () => {
    it('should load environments from API', async () => {
      const mockEnvs = [
        { id: '1', name: 'Production', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 },
        { id: '2', name: 'Staging', description: '', connection_mode: 'agent', created_at: '', updated_at: '', resource_count: 0 },
      ]
  ...
  describe('createEnvironment', () => {
    it('should add new environment to list', async () => {
      const newEnv = { id: '3', name: 'New', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 }
  ...
  describe('updateEnvironment', () => {
    it('should update environment in list', async () => {
      const store = useEnvironmentsStore()
      store.environments = [
        { id: '1', name: 'Old', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 },
      ]
      mockEnvironmentsApi.update.mockResolvedValue({ id: '1', name: 'Updated', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 })
  ...
  describe('deleteEnvironment', () => {
    it('should remove environment from list', async () => {
      const store = useEnvironmentsStore()
      store.environments = [
        { id: '1', name: 'ToDelete', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 },
      ]
      mockEnvironmentsApi.delete.mockResolvedValue(undefined)
  ...
  describe('createResource', () => {
    it('should increment environment resource_count', async () => {
      const store = useEnvironmentsStore()
      store.environments = [
        { id: '1', name: 'Env', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 0 },
      ]
  ...
  describe('deleteResource', () => {
    it('should decrement environment resource_count', async () => {
      const store = useEnvironmentsStore()
      store.environments = [
        { id: '1', name: 'Env', description: '', connection_mode: 'direct', created_at: '', updated_at: '', resource_count: 2 },
      ]
      mockResourcesApi.delete.mockResolvedValue(undefined)
